...
describe("aggregate scenarios", function () {
    var provider;
    var collection;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, collection.aggregate([{ $match: { hello: true } }])];
                    case 5:
                        model = _a.sent();
    ...
    it("should do $gte aggregate", function (done) {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            var i, model;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, collection.aggregate([
                            { $match: { number: { $gte: 5 } } }
                        ])];
                    case 5:
                        model = _a.sent();
    ...
    it("should do $elemMatch aggregate on subarray", function (done) {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            var i, model;
            return __generator(this, function (_a) {
                switch (_a.label) {
